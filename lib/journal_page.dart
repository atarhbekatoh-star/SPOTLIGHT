...
class _JournalPageState extends State<JournalPage> {
  ...
  Future<void> _loadPastJournals() async {
    ...
    if (mounted) {
      setState(() {
        _pastJournals = existing.map((e) => jsonDecode(e) as Map<String, dynamic>).toList();
      });
    }
  }
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              formattedDate,
                              style: TextStyle(color: purpleGlow.withAlpha(150), fontSize: 12),
                            ),
                            if (mood != null)
                              Text(
                                mood.toString(),
                        ...
                        if (hasImage || hasVoice) ...[
                          ...
                          Row(
                            children: [
                              if (hasImage) Icon(Icons.image, color: purpleGlow.withAlpha(150), size: 16),
                              if (hasImage && hasVoice) const SizedBox(width: 8),
                              if (hasVoice) Icon(Icons.mic, color: purpleGlow.withAlpha(150), size: 16),
                            ],
                          ),
                        ]
                      ],
